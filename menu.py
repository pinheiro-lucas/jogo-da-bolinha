...
def texto_ret(ret, msg):
    ...
    # Valor entre 5-36
    self.setSize(resolucao // 30)  # 25
    self.draw(menu)
    return self

# Função de Texto sem Retângulo
def texto_sem_ret(x, y, tamanho, msg):
    global botoes, resolucao
    ...
    self.setFace('times roman')
    # Valor entre 5-36
    self.setSize(resolucao//tamanho)  # 25
    self.draw(menu)
    return self
...
def menu_dificuldade():
    ...
    texto4 = texto_sem_ret(50, 10, 30, f'DIFICULDADE ATUAL: {dificuldades[dificuldade - 1]}')
...
def menu_comojogar():
    ...
    texto2 = texto_sem_ret(50, 10, 20, 'COMO JOGAR:')
    texto3 = texto_sem_ret(50, 20, 35, 'Você tem três vidas')
    texto4 = texto_sem_ret(50, 25, 35, 'Não deixe a bolinha cair')
    texto5 = texto_sem_ret(50, 30, 35, 'A velocidade aumenta conforme o tempo')
    texto6 = texto_sem_ret(50, 35, 35, 'Utilize as setinhas para controlar a barra')
    texto7 = texto_sem_ret(50, 40, 35, 'Recupere a vida coletando os corações')
    texto8 = texto_sem_ret(50, 45, 35, 'Aproveite os modos mais desafiadores')
...
def menu_creditos():
    ...
    texto2 = texto_sem_ret(50, 10, 20, 'CRÉDITOS:')
    texto3 = texto_sem_ret(50, 20, 35, 'Lucas Pinheiro')
    texto4 = texto_sem_ret(50, 25, 35, 'Thiago Rabelo')
    texto5 = texto_sem_ret(50, 30, 35, 'Giulia Yule')
    texto6 = texto_sem_ret(50, 35, 35, 'Maria Antônia')
    texto7 = texto_sem_ret(50, 40, 35, 'Luiz Falcão')
...
def menu_principal():
    ...
    texto0 = texto_sem_ret(50, 10, 20, 'MENU PRINCIPAL')
